...
public class TeamMenu : VBoxContainer
{
    ...
    public void Init(string playerNode)
    {
        ...
        this.AddChild(b);
        b.Connect("pressed", this, "JoinTeam", new Godot.Collections.Array {1, playerNode});
        Button b2 = new Button();
        b2.Text = "Team 2";
        b2.SizeFlagsVertical = (int)SizeFlags.ExpandFill;
        this.AddChild(b2);
        b2.Connect("pressed", this, "JoinTeam", new Godot.Collections.Array {2, playerNode});
        Button b9 = new Button();
        b9.Text = "Spectator";
        b9.SizeFlagsVertical = (int)SizeFlags.ExpandFill;
        this.AddChild(b9);
        b9.Connect("pressed", this, "JoinTeam", new Godot.Collections.Array {9, playerNode});
